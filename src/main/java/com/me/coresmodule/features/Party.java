...
public class Party {
    ...
    public static void fParty(String[] args) {
        partyMembers.clear();
                ...
                if (!pMember.equals(playerOwner)) {
                    MutableComponent comp = Component.literal("§a" + pMember)
                            .withStyle(style -> style
                                    .withHoverEvent(new HoverEvent.ShowText(Component.literal("§eadd §c" + pMember)))
    ...
    public static void register() {
        Register.onChatMessage(Party::onChatMessage);
        Register.command("fp", Party::fParty, "fParty");
